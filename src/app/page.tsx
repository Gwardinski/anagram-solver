...
export default function Home() {
  return (
    <section className="justify-center flex flex-col items-center mx-auto px-4 gap-2 lg:gap-4 min-h-full">
      <header className="h-32 w-full flex flex-col justify-center items-center gap-2 text-center">
        ...
        <h4 className="text-md bg-gradient-to-b from-purple-300 to-blue-300 bg-clip-text font-extrabold tracking-wider text-transparent">
